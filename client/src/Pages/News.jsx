...
const News = () => {
  ...
  return (
    <>
            ...
            <a href={slide.url} target="_blank" rel="noopener noreferrer">
              ...
              >
                <div className="mt-52 mr-20 text-left">
                  ...
                  <div className="mb-3 text-lg text-black dark:text-gray-400 bg-slate-100 bg-opacity-50 mt-4">
                    {slide.description}
                    {"..."}
                  </div>
                </div>
      ...
      <div className="grid mt-8 md:grid-cols-3 gap-7 sm:grid-cols-2 2xl:grid-cols-4">
        {newdata.map((value) => (
          <NewsCard
